	...
	return (
		<>
			<article id="bg-gradient" className='relative rounded-2xl m-1 h-16 w-16 flex justify-between flex-col gap-3 items-center md:h-40 md:w-40 '>
				...
				<div className='absolute mr-16 top-[27px] md:mr-40 md:top-[70px] h-3 w-3 md:h-5 md:w-5 bg-neutral-dark-blue rounded-full'></div>
				<div className='absolute ml-16 top-[27px] md:ml-40 md:top-[70px] h-3 w-3 md:h-5 md:w-5 bg-neutral-dark-blue rounded-full'></div>
			</article>
		</>
	);
};
